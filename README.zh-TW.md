...
*實際完工的裝置，攝於 2026-09-20。花盆周圍的鋁箔是防蕈蚋屏障，不是封死的蓋子——為什麼打孔之後還是有效，見下方[澆水邏輯](#澆水邏輯)一節。幼苗明顯徒長——莖細長、葉片稀疏泛白，這個症狀在下方「補光燈」一節有實測數據可以解釋。OLED 上的 `TANK -0.0%` 讀數是真實存在、目前尚未查明原因的，詳見[已知問題](#已知問題--待辦)一節。*
