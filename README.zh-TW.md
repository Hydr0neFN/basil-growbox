...
*實際完工的裝置，攝於 2026-09-20。花盆周圍的鋁箔是防蕈蚋屏障，不是封死的蓋子——為什麼打孔之後還是有效，見下方[澆水邏輯](#澆水邏輯)一節。幼苗明顯徒長——莖細長、葉片稀疏泛白，這個症狀在下方「補光燈」一節有實測資料可以解釋。OLED 上的 `TANK -0.0%` 讀數是真實存在的。這張照片攝於 12:41，晚於水位感測器當天最後一次正常讀值的 10:46，所以它顯示的多半就是[已知問題](#已知問題--待辦)裡那個故障，而不是另一個獨立的謎團——不過韌體本身會把這個百分比箝制在 0–100，所以負值仍然沒有被完全解釋。*
...
另外值得檢查的：ECHO 的 1k/2k 分壓電路是否有線被扯掉，以及同一天早上裝上去的
鋁箔有沒有碰到端子。上面提過的鋁箔導電風險並不是紙上談兵——它會導電，而且就
緊鄰繼電器板和 12V 電源軌。
